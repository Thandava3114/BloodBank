...
public class BloodGroup  extends JFrame implements ActionListener{
    JFrame f;
    JTable t;
    JLabel l1,l2,l3,l4;
    JComboBox cb1;
    ...
    BloodGroup()
    {
        ...
        l2=new JLabel("Search Donor By Blood group");
        l2.setBounds(130, -30, 450, 100);
        l2.setForeground(Color.BLACK);
        l2.setFont(new Font("Comic Sans MS",Font.BOLD,30));
        l1.add(l2);
        
        l3=new JLabel("Blood Group");
        l3.setBounds(145, 60, 150, 20);
        l3.setForeground(Color.BLACK);
        l3.setFont(new Font("Comic Sans MS",Font.BOLD,15));
        l1.add(l3);
        
        l4=new JLabel();
        l4.setBounds(235,60,20,20);
        l4.setLayout(null);
        ImageIcon i2=new ImageIcon(ClassLoader.getSystemResource("BBM/Blood group.png"));
        ...
        cb1=new JComboBox();
        cb1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "select", "A+","B+","AB+","O+","A-","B-","AB-","O-"}));
        cb1.setBounds(270, 60, 130, 25);
