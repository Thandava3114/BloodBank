...
public class DeleteDonor extends JFrame implements ActionListener{
    ...
    DeleteDonor()
    {
        ...
        l2=new JLabel("Delete Donor");
        l2.setBounds(250, -30, 400, 100);
        ...
        ImageIcon icon1=new ImageIcon("C:\\Users\\KRISHNA\\Desktop\\Internship\\BloodBankManagementSystem(2)\\src\\delete.png");
        b1=new JButton("Delete",icon1);
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==b1)
        {
            ...
            try
            {
                ...
                int a=JOptionPane.showConfirmDialog(null,"Do you really want to Delete Donor...?","Select",JOptionPane.YES_NO_OPTION);
                if(a==0)
                {
                    f.setVisible(true);
